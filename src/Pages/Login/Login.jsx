    ...
    const handleLogin = (e) => {
        ...
        SignIn(email, password)
            .then(result => {
                ...
                // get access token                
                axios.post('https://car-doctor-server-beryl-seven.vercel.app/jwt', user, {withCredentials: true})
                .then(res =>{
                    ...
                    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                            ...
                            <form onSubmit={handleLogin} action="" className="space-y-6">
                                ...
                                <input className='btn btn-primary w-1/2 items-center' type='submit' value='login'></input>
                                ...
                                <p className="text-xs text-center sm:px-6 dark:texts-gray-600">Do not have an account?
